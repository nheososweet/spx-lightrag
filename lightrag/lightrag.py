...
class LightRAG:
        ...
        try:
            ...
            if chunk_ids:
                ...
                if orphaned_entities:
                    ...
                    await self.entities_vdb.soft_delete(orphaned_entities)
    ...
    async def asoft_delete_by_doc_id(
        ...
        try:
            ...
            return await self._asoft_delete_doc_internal(doc_id)
         ...
         try:
            ...
            if chunk_ids:
                ...
                if doc_entities_data and "entity_names" in doc_entities_data:
                    ...
                    await self.entities_vdb.soft_delete(entity_names, is_deleted=False)
    ...
    async def aactive_by_doc_id(
        ...
        try:
            ...
            return await self._aactive_doc_internal(doc_id)
